...
%% User input
    dTms = 20; % Присвойте значение интервалу времени в десятых долях миллисекунды (любое число от 1 до 160)
    channels = 1; % Присвойте значение количеству цветовых каналов (либо 1, либо 3)
